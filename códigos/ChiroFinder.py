...
class btn_cambio (tk.Button):
    def __init__(self, texto, comando, pestaña):
        ...
        self.configure(text=texto, width=39, font=font, bg="White", wraplength=480, command=lambda:comando.switch(pestaña))
...
class btn_resultado (tk.Button):
    def __init__(self, texto, comando, especie, imagen):
        ...
        font=Tkfont.Font(family="Cascadia Code", size=15)
        self.configure(text=texto, width=39, font=font, bg="White", wraplength=480, command=lambda:[respuesta(especie, imagen), comando.switch(inicio)])
...
class inicio (Canvas):
    def __init__(self, comand):
        ...
        inicio.configure(width=30, font=Tkfont.Font(family="Cascadia Code", size=18))
        creditos=btn_cambio("Créditos", comand, créditos)
        creditos.configure(width=30, font=Tkfont.Font(family="Cascadia Code", size=18))
        self.create_image(0, 0, image=fondo, anchor="nw")
        self.create_image(500, 20, image=logo, anchor="n")
        self.create_window(250, 325, window=inicio)
        self.create_window(750, 325, window=creditos)
...
class preg_murc_2 (Canvas):
    def __init__(self, comand):
        ...
        op_1.configure(height=15)
        op_2=btn_cambio("Ausente", comand, preg_murc_33)
        op_2.configure(height=15)
...
class preg_murc_5 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(0,0, anchor="nw", image=fondo)
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Calcar(o calcáneo):", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 325, window=op_1)
        self.create_window(750, 325, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
...
class preg_murc_7 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(0,0, anchor="nw", image=fondo)
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Antebrazo de:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 325, window=op_1)
        self.create_window(750, 325, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
...
class preg_murc_8 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Seleccione la opción más acertada:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 440, window=op_1)
        self.create_window(750, 440, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
        self.logo_ref=logo
...
class preg_murc_10 (Canvas):
    def __init__(self, comand):
        ...
        op_1.configure(width=31, wraplength=300, font=font_2)
        ...
        op_2.configure(width=31, wraplength=300, font=font_2)
        ...
        op_3.configure(width=31, wraplength=300, font=font_2)
        volver=btn_cambio("Volver", comand, preg_murc_3)
        volver.configure(width=10)
        self.create_image(0,0, anchor="nw", image=fondo)
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Seleccione la opción más acertada:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(175, 420, window=op_1)
        self.create_window(500, 420, window=op_2)
        self.create_window(825, 420, window=op_3)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
        self.logo_ref=logo
...
class preg_murc_19 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(0,0, anchor="nw", image=fondo)
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Pelos dorsales:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 325, window=op_1)
        self.create_window(750, 325, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
...
class preg_murc_20 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(0,0, anchor="nw", image=fondo)
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Ornamento de barbilla:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 325, window=op_1)
        self.create_window(750, 325, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
...
class preg_murc_21 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Seleccione la opción más acertada:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 375, window=op_1)
        self.create_window(750, 375, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
        self.logo_ref=logo
...
class preg_murc_23 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Seleccione la opción más acertada:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 350, window=op_1)
        self.create_window(750, 350, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
        self.logo_ref=logo
...
class preg_murc_29 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(0,0, anchor="nw", image=fondo)
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Incisivos interiores superiores:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 325, window=op_1)
        self.create_window(750, 325, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
...
class preg_murc_33 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(0,0, anchor="nw", image=fondo)
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Selecciona la opción más acertada:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 325, window=op_1)
        self.create_window(750, 325, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
...
class preg_murc_34 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(0,0, anchor="nw", image=fondo)
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Dorso:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 325, window=op_1)
        self.create_window(750, 325, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
...
class preg_murc_35 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(0,0, anchor="nw", image=fondo)
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Extensión de la línea dorsal:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 325, window=op_1)
        self.create_window(750, 325, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
...
class preg_murc_36 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Seleccione la opción más acertada:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 400, window=op_1)
        self.create_window(750, 400, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
        self.logo_ref=logo
...
class preg_murc_37 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Selecciona la opción más acertada:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 435, window=op_1)
        self.create_window(750, 435, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
        self.logo_ref=logo
...
class preg_murc_38 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Seleccione la opción más acertada:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 330, window=op_1)
        self.create_window(750, 330, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
        self.logo_ref=logo
...
class preg_murc_39 (Canvas):
    def __init__(self, comand):
        ...
        op_1.configure(width=42, font=font_2)
        ...
        op_2.configure(width=42, font=font_2)
...
class preg_murc_40 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Seleccione la opción más acertada:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 430, window=op_1)
        self.create_window(750, 430, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
        self.logo_ref=logo
...
class preg_murc_41 (Canvas):
    def __init__(self, comand):
        ...
        self.create_image(0,0, anchor="nw", image=fondo)
        self.create_image(500, 20, anchor="n", image=logo)
        self.create_text(500, 230, text="Antebrazo:", font=font_1, justify=tk.CENTER, width=600)
        self.create_window(250, 325, window=op_1)
        self.create_window(750, 325, window=op_2)
        self.create_window(10, 10, window=volver, anchor="nw")
        self.fondo_ref=fondo
