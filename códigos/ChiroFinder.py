...
class preg_murc_4 (Canvas):
    def __init__(self, comand):
        ...
        op_2=btn_resultado("Posee el margen posterior de la membrana interfemoral desnudo, orejas y hoja de la nariz mucho más alargado que la cabeza, peso corporal +/- 18g, antebrazo 49-54mm", preg_murc_4, "Lonchorhina aurita", "Imagenes usadas/m.png")
...
class preg_murc_11 (Canvas):
    def __init__(self, comand):
        ...
        fondo=PhotoImage(file="Imagenes usadas/Fondo.png")
        logo=PhotoImage(file="Imagenes usadas/logo.png")
        op_1=btn_resultado("Orejas cortas, no se extienden más allá de la nariz cuando se las coloca hacia adelante, peso corporal +/-126g y antebrazo de 80-93mm", preg_murc_11, "Phyllostomus hastatus", "Imagenes usadas/m.png")
...
class preg_murc_13 (Canvas):
    def __init__(self, comand):
        ...
        fondo=PhotoImage(file="Imagenes usadas/Fondo.png")
        logo=PhotoImage(file="Imagenes usadas/logo.png")
        op_1=btn_resultado("Antebrazo +70mm, pelo largo y lanoso, herradura de la hoja de la nariz fuertemente bordeada ventralmente, peso corporal +/-84g y antebrazo de 77-83mm", preg_murc_13, "Chrotopterus auritus", "Imagenes usadas/m.png")
...
class preg_murc_14 (Canvas):
    def __init__(self, comand):
        ...
        fondo=PhotoImage(file="Imagenes usadas/Fondo.png")
        logo=PhotoImage(file="Imagenes usadas/logo.png")
        op_1=btn_resultado("Antebrazo peludo, línea blanca en corona, gargante gris, peso corporal +/-36g y antebrazo de 56-61mm", preg_murc_14, "Tonatia saurophila", "Imagenes usadas/m.png")
        op_2=btn_resultado("Antebrazo casi desnudo, sin línea en la corona, garganta blanca o blanquizca, cara desnuda, coloca las orejas para atrás cuando se toca la cabeza, peso corporal +/-34g y antebrazo 50-56mm", preg_murc_14, "Lophostoma silvicola", "Imagenes usadas/m.png")
...
class preg_murc_18 (Canvas):
    def __init__(self, comand):
        ...
        op_2=btn_resultado("Alas sin puntas blancas, tragus contundente, peso corporal +/-42g, antebrazo de 60-68mm", preg_murc_18, "Phyllostomus discolor", "Imagenes usadas/m.png")
...
class preg_murc_27 (Canvas):
    def __init__(self, comand):
        ...
        fondo=PhotoImage(file="Imagenes usadas/Fondo.png")
        logo=PhotoImage(file="Imagenes usadas/logo.png")
        op_1=btn_resultado("Antebrazo +40mm, peso corporal +/-15g y antebrazo de 40-45mm", preg_murc_27, "Lonchophylla robusta", "Imagenes usadas/m.png")
...
class preg_murc_42 (Canvas):
    def __init__(self, comand):
        ...
        fondo=PhotoImage(file="Imagenes usadas/Fondo.png")
        logo=PhotoImage(file="Imagenes usadas/logo.png")
        op_1=btn_resultado("Extremidades posteriores prácticamente desnudas, líneas faciales indistintas, peso corporal +/-48g y antebrazo de 55-67mm", preg_murc_42, "Artibeus jamaicensis", "Imagenes usadas/m.png")
...
class preg_murc_43 (Canvas):
    def __init__(self, comand):
        ...
        fondo=PhotoImage(file="Imagenes usadas/Fondo.png")
        logo=PhotoImage(file="Imagenes usadas/logo.png")
        op_1=btn_resultado("Dos pares de líneas faciales brillantes, peso corporal +/-67g y antebrazo de 69-78mm", preg_murc_43, "Artibeus lituratus", "Imagenes usadas/m.png")
...
class preg_murc_54 (Canvas):
    def __init__(self, comand):
        ...
        fondo=PhotoImage(file="Imagenes usadas/Fondo.png")
        logo=PhotoImage(file="Imagenes usadas/logo.png")
        op_1=btn_resultado("Puntas de las alas blancas, peso corporal +/-36g y antebrazo de 48-54mm", preg_murc_54, "Desmodus youngii", "Imagenes usadas/m.png")
...
class preg_murc_59 (Canvas):
    def __init__(self, comand):
        ...
        fondo=PhotoImage(file="Imagenes usadas/Fondo.png")
        logo=PhotoImage(file="Imagenes usadas/logo.png")
        op_1=btn_resultado("De color amarillo, alas negras, peso corporal +/-11g y antebrazo de 43-47mm", preg_murc_59, "Lasiurus ega", "Imagenes usadas/m.png")
...
class preg_murc_74 (Canvas):
    def __init__(self, comand):
        ...
        op_2=btn_resultado("Pelos dorsales con poco contraste entre las puntas y las bases, peso corporal +/-32g y antebrazo de 46-51mm", preg_murc_74, "Molossus ater", "Imagenes usadas/m.png")
...
class preg_murc_81 (Canvas):
    def __init__(self, comand):
        ...
        fondo=PhotoImage(file="Imagenes usadas/Fondo.png")
        logo=PhotoImage(file="Imagenes usadas/logo.png")
        op_1=btn_resultado("Pequeño, pecho blanquizco, peso corporal +/-13g y antebrazo de 31-36mm", preg_murc_81, "Molossops paranus", "Imagenes usadas/m.png")
        op_2=btn_resultado("Grande, color del pecho no diferenciado, negruzco o chocolate, peso corporal +/-20g y antebrazo de 34-38mm", preg_murc_81, "Molossops greenhalli", "Imagenes usadas/m.png")
        volver=btn_normal("Volver", preg_murc_76)
        volver.configure(width=10, height=1)
        self.create_image(0,0, anchor="nw", image=fondo)
        self.create_image(500, 20, anchor="n", image=logo)
...
class preg_murc_89 (Canvas):
    def __init__(self, comand):
        ...
        fondo=PhotoImage(file="Imagenes usadas/Fondo.png")
        logo=PhotoImage(file="Imagenes usadas/logo.png")
        op_1=btn_resultado("Ala conectada cerca de la base de los dedos del pie, saco cerca de antebrazo, peso corporal +/-9g y antebrazo de 45-48mm", preg_murc_89, "Cormura brevirostris", "Imagenes usadas/m.png")
...
class preg_murc_90 (Canvas):
    def __init__(self, comand):
        ...
        op_2=btn_resultado("Pequeño, peso corporal +/-5g y antebrazo de 37-44mm", preg_murc_90, "Peropteryx microtis", "Imagenes usadas/m.png")
