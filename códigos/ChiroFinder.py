...
class créditos (Canvas):
    def __init__(self, comand):
        ...
        imagen_final.clear()
        fondo=PhotoImage(file="Imagenes usadas/Fondo.png")
        logo=PhotoImage(file="Imagenes usadas/logo2.png")
        senacyt=PhotoImage(file="Imagenes usadas/SENACYT-logo.png")
        colsape=PhotoImage(file="Imagenes usadas/COLSAPE-logo.png")
        cruc=PhotoImage(file="Imagenes usadas/CRUC-logo.png")
        ...
        self.create_image(875, 225, anchor="n", image=colsape)
        self.create_image(875, 350, anchor="n", image=cruc)
        self.create_image(875, 475, anchor="n", image=cidete)
        self.create_window(10, 10, anchor="nw", window=volver)
        self.create_text(500, 110, text="CRÉDITOS", font=font_1, width=480)
        self.create_text(20, 150, anchor="w", text="José Huertas - Desarrollador", width=700, font=font_2)
        self.create_text(20, 190, anchor="w", text="José Fung - Mentor", width=700, font=font_2)
        ...
        self.colsape_ref=colsape
        self.cruc_ref=cruc
        self.cidete_ref=cidete
...
class preg_murc_36 (Canvas):
    def __init__(self, comand):
        ...
        op_2=btn_resultado("Puntas de las alas no blancas, línea dorsal blanca brillante, membrana interfemoral (MI) angosta, en forma de 'V' y fuertemente orlada, pelos dorsales tricoloridos (la banda basal a veces indistinto) márgenes de las orejas y tragus amarillos o naranjas, de pequeño tamaño, peso corporal +/-17g y antebrazo de 37-41mm", preg_murc_36, "Platyrrhinus helleri", "Imagenes usadas/Murciélagos/Platyrrhinus helleri.png")
...
class preg_murc_43 (Canvas):
    def __init__(self, comand):
        ...
        op_2=btn_resultado("Normalmente solo un par de líneas faciales (sobre los ojos), líneas abajo de los ojos pueden ser presentes, pero indistintas, peso corporal +/-61g y antebrazo de 61-68mm", preg_murc_43, "Artibeus intermedius", "Imagenes usadas/Murciélagos/Artibeus intermedius.png")
